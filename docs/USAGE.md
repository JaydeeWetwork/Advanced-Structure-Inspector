...
**Zip / world too large** — import stops if an archive expands past 64 MiB, a single entry is over 64 MiB, or more than 64 `.mcstructure` files are inside. Encrypted zip members are skipped.
