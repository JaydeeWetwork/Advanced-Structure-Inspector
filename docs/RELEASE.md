...
- **Inspect** (double-click): chests (including double chests), hoppers, droppers, minecart cargo, signs, lecterns, item frames, and similar block entities
...
Requires **Node.js 18+** and a WebGL2 browser.
